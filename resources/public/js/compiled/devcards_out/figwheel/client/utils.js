...
return (new CustomEvent(event_name,(function (){var obj31554 = {"detail":data};
return obj31554;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__24806__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__24806__auto__)){
var and__24806__auto____$1 = (window["CustomEvent"]);
...
var args31559 = [];
var len__25893__auto___31565 = arguments.length;
var i__25894__auto___31566 = (0);
while(true){
if((i__25894__auto___31566 < len__25893__auto___31565)){
args31559.push((arguments[i__25894__auto___31566]));

var G__31567 = (i__25894__auto___31566 + (1));
i__25894__auto___31566 = G__31567;
continue;
} else {
}
break;
...
var expr__31563 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
...
return console.warn(p1__31555_SHARP_);
});
...
return console.debug(p1__31556_SHARP_);
});
;})(pred__31562,expr__31563))
} else {
...
return console.error(p1__31557_SHARP_);
});
;})(pred__31562,expr__31563))
} else {
return ((function (pred__31562,expr__31563){
return (function (p1__31558_SHARP_){
return console.log(p1__31558_SHARP_);
});
;})(pred__31562,expr__31563))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31569){
...
return new_def.callback(p1__31574_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__31576,(0),null);
var v = cljs.core.nth.call(null,vec__31576,(1),null);
...
var args31579 = [];
var len__25893__auto___31582 = arguments.length;
var i__25894__auto___31583 = (0);
while(true){
if((i__25894__auto___31583 < len__25893__auto___31582)){
args31579.push((arguments[i__25894__auto___31583]));

var G__31584 = (i__25894__auto___31583 + (1));
i__25894__auto___31583 = G__31584;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__24806__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1530813179729