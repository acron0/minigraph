...
var x__25481__auto__ = (((x == null))?null:x);
var m__25482__auto__ = (sablono.util.to_str[goog.typeOf(x__25481__auto__)]);
if(!((m__25482__auto__ == null))){
return m__25482__auto__.call(null,x);
} else {
var m__25482__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__25482__auto____$1 == null))){
return m__25482__auto____$1.call(null,x);
} else {
...
var x__25481__auto__ = (((x == null))?null:x);
var m__25482__auto__ = (sablono.util.to_uri[goog.typeOf(x__25481__auto__)]);
if(!((m__25482__auto__ == null))){
return m__25482__auto__.call(null,x);
} else {
var m__25482__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25482__auto____$1 == null))){
return m__25482__auto____$1.call(null,x);
} else {
...
var len__25893__auto___41176 = arguments.length;
var i__25894__auto___41177 = (0);
while(true){
if((i__25894__auto___41177 < len__25893__auto___41176)){
args__25900__auto__.push((arguments[i__25894__auto___41177]));

var G__41178 = (i__25894__auto___41177 + (1));
i__25894__auto___41177 = G__41178;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__25901__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq41175){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq41175));
});
...
var vec__41182 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__41183 = cljs.core.seq.call(null,vec__41182);
var first__41184 = cljs.core.first.call(null,seq__41183);
var seq__41183__$1 = cljs.core.next.call(null,seq__41183);
var first_word = first__41184;
var words = seq__41183__$1;
...
var G__41186 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__41186,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__41186;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__41187_SHARP_){
if(typeof p1__41187_SHARP_ === 'string'){
return p1__41187_SHARP_;
} else {
return cljs.core.seq.call(null,p1__41187_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__24818__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1530813195975